...
#import "OPHuWaiViewController.h"

@interface OPHuWaiViewController ()

@end

@implementation OPHuWaiViewController
...
- (void)viewDidLoad
{
  ...
  //调整导航条
  self.navigationItem.title=@"户外工具";
